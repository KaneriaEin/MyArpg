...
public abstract class CommandControllerBase : MonoBehaviour
{
    ...
    public abstract bool GetSkillKeyHoldState(int skillIndex);
    public abstract bool GetStandKeyState();
    public abstract bool GetStandKeyHoldState();
    public abstract bool GetHeavyKeyState();
    public abstract bool GetWalkKeyState();
    public abstract bool GetDodgeKeyState();
    public abstract bool GetGuardKeyState();

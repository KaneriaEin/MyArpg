...
public abstract class GameCharacterStateBase:StateBase
{
    ...
    protected bool CheckSkillInput()
    {
        ...
        {
            valid = (gameCharacter.CommandController.GetSkillKeyState(i - 3) || gameCharacter.CommandController.GetSkillKeyHoldState(i - 3)) && gameCharacter.SkillBrain.CheckReleaseSkill(i);
